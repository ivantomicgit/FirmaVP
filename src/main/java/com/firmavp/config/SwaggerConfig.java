/*
 * package com.firmavp.config; import
 ...
 * .apis(RequestHandlerSelectors.basePackage("com.firmavp.controller"))
 * .paths(regex("/api.*")) .build() .apiInfo(metaData()); } private ApiInfo
 * metaData() { return new ApiInfoBuilder() .title("Vozila")
 * .description("\"Vozila\"") .version("1.0.0")
